...
public class Config {
    ...
    public double huntingMusketbulletStdDev; //copy of musketitem (which uses those without 'huntingMusket' prefix)
    public double huntingMusketbulletSpeed;
    public double huntingMusketdamageMin;
    public double huntingMusketdamageMax;
    ...
    public static void reload() {
        ...
        HuntingMusketItem.bulletStdDev = (float)Math.toRadians(INSTANCE.huntingMusketbulletStdDev); //referencing HuntingMusketItem and public doubles defined above (copy of MusketItem)
        HuntingMusketItem.bulletSpeed = (float)(INSTANCE.huntingMusketbulletSpeed / 20);
        maxEnergy = HuntingMusketItem.bulletSpeed * HuntingMusketItem.bulletSpeed;
        HuntingMusketItem.damageMultiplierMin = (float)(INSTANCE.huntingMusketdamageMin / maxEnergy);
        HuntingMusketItem.damageMultiplierMax = (float)(INSTANCE.huntingMusketdamageMax / maxEnergy);
    ...
    private void setDefaults() {
        ...
        huntingMusketbulletStdDev = 4.5; //values for the hunting musket: it's awfully inaccurate but deals deadly damage
        huntingMusketbulletSpeed = 90;
        huntingMusketdamageMin = 30.5;
        huntingMusketdamageMax = 51;
