...
public abstract class GunItem extends Item {
    public static final int LOADING_STAGE_1 = 10;
    public static final int LOADING_STAGE_2 = 15;
    public static final int LOADING_STAGE_3 = 25;
    public static final int RELOAD_DURATION = 75;
